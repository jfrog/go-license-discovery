...
(function () {
    ...
    a.param = b(function (f, q, o, j, s) {
        ...
        function m(x, w) {
            var u = "", v;
            u += "\n		";
            v = o["if"].call(x, x.isFile, {hash: {}, inverse: n.program(4, k, w), fn: n.program(2, l, w), data: w});
            if (v || v === 0) {
                u += v
            }
            u += "\n	";
        ...
        p += c(g) + "</td>\n<td>\n\n	";
        g = o["if"].call(q, q.isBody, {hash: {}, inverse: n.program(9, e, s), fn: n.program(1, m, s), data: s});
        if (g || g === 0) {
            p += g
        }
        p += "\n\n</td>\n<td>";
...
(function () {
    ...
    u = (function (y) {
        ...
        z.prototype.render = function () {
            ...
            E = {};
            B = 0;
            F = this.model.apisArray;
            for (C = 0, A = F.length; C < A; C++) {
                D = F[C];
                G = D.name;
                while (typeof E[G] !== "undefined") {
                    G = G + "_" + B;
                    B += 1
                }
                D.id = G;
        ...
        z.prototype.addResource = function (B) {
            var A;
            A = new n({model: B, tagName: "li", id: "resource_" + B.id, className: "resource"});
    ...
    o = (function (z) {
        ...
        y.prototype.showStatus = function (A) {
            var E, D, H, G, F, C, B;
            if (A.content === void 0) {
                D = A.data;
                B = A.url
            ...
            G = A.headers;
            H = G && G["Content-Type"] ? G["Content-Type"].split(";")[0].trim() : null;
            if (!D) {
                E = $("<code />").text("no content");
                F = $('<pre class="json" />').append(E)
            } else {
                if (H === "application/json" || /\+json$/.test(H)) {
                    E = $("<code />").text(JSON.stringify(JSON.parse(D), null, "  "));
                    F = $('<pre class="json" />').append(E)
                } else {
                    if (H === "application/xml" || /\+xml$/.test(H)) {
                        E = $("<code />").text(this.formatXml(D));
                        F = $('<pre class="xml" />').append(E)
                    } else {
                        if (H === "text/html") {
                            E = $("<code />").html(D);
                            F = $('<pre class="xml" />').append(E)
            ...
            C = F;
            $(".request_url", $(this.el)).html("<pre>" + B + "</pre>");
            $(".response_code", $(this.el)).html("<pre>" + A.status + "</pre>");
            $(".response_body", $(this.el)).html(C);
            $(".response_headers", $(this.el)).html("<pre>" + JSON.stringify(A.headers, null, "  ").replace(/\n/g, "<br>") + "</pre>");
